...
export default function ImagenUploadC({image} : {image: string | undefined}){
            ...
            {({open}) => (
                <>
                    <div className='spcae-y-2'>
                        <label className='text-slate-800'>Imagen Categoria</label>
